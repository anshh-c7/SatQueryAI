...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      requiresMap: Boolean(fileName || chatResult.requiresMap || chatResult.mapData || chatResult.spatialOutput),
      mapData: chatResult.mapData,
      spatialOutput: chatResult.spatialOutput,
