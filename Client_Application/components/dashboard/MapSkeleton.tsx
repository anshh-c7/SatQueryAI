...
export const MapSkeleton: React.FC = () => {
  return (
    <div className="relative w-full h-full min-h-[500px] bg-[#EFE8DE] overflow-hidden flex items-center justify-center">
      {/* Background simulated warm grid */}
      <div
        className="absolute inset-0 opacity-10 bg-[radial-gradient(#1C1917_1px,transparent_1px)] [background-size:32px_32px]"
      />
      ...
      {/* Coordinate bar */}
      <div className="liquid-glass absolute bottom-4 left-4 z-10 font-mono text-[10px] text-secondary px-3 py-1 rounded-full border border-white/60 shadow-xs">
